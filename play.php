...
$con = conectar();
// Obtenemos los juegos de la plataforma play desde la base de datos
$resultado = obtener_play($con);
...
<head>
    ...
    <link rel="shortcut icon" href="imgs/ps3.png">
...
<div class="play">
    <img class="logos" src="imgs\ps22.png">
    <br><br><br>
    <H2 style='margin-left: 65px; color:white;' class ="dodgerblue">PLAYSTATION</H2>
</div>    
</section>
<style>
...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    echo "</div>";
    echo "<p><h2 style='color: dodgerblue;'>Género:</h2><br> <p style='color: white;'>$genero</p><br>";
    echo "<p><h2 style='color: dodgerblue;'>Plataforma:</h2><br> <p style='color: white;'>$plataforma</p><br>";
    echo "<div class='comentarios'>";
    echo "<h2 style='color: dodgerblue;'>Comentarios:</h2><br><p style='color: white;'>$comentarios</p><br>";
    echo "</div>";
    echo "<p><h2 style='color: dodgerblue;'>Enlace:</h2><br> <a href='$link' style='color: white;'>$link</a></p>";
    echo "</div>";
}
echo "</div>";
?>
