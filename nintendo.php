...
$con = conectar();
// Obtenemos los juegos de la plataforma nintendo desde la base de datos
$resultado = obtener_nintendo($con);
?>
...
<head>
    ...
    <link rel="shortcut icon" href="imgs/nintendo2.png">
...
<div class="play">
    <img class="logos" src="imgs\nintendo22.png">
    <br><br><br>
    <H2 style='margin-left: 100px; color:white' class ="red">NINTENDO</H2>
</div>    
</section>
<style>
...
<?php
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
        ...
        echo "<div style='border: 5px solid red;' class='juego'>";
        echo "<div style='width: 200px 'align-items: center';'>";
        echo "<img class='imagen' src='imgs/imagen_$id_juego.png' alt='$nombre'>";
        echo "<h2 style='color: white;'>$nombre</h2><br>";
        echo "</div>";
        echo "<p><h2 style='color: red;'>Género:</h2><br> <p style='color: white;'>$genero</p><br>";
        echo "<p><h2 style='color: red;'>Plataforma:</h2><br> <p style='color: white;'>$plataforma</p><br>";
        echo "<div class='comentarios'>";
        echo "<h2 style='color: red;'>Comentarios:</h2><br><p style='color: white;'>$comentarios</p><br>";
        echo "</div>";
        echo "<p><h2 style='color: red;'>Enlace:</h2><br> <a href='$link' style='color: white;'>$link</a></p>";
        echo "</div>";
    }
    echo "</div>";
