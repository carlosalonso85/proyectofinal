...
$con = conectar();
// Obtenemos los juegos de la plataforma pc desde la base de datos
$resultado = obtener_pc($con);
...
<head>
    ...
    <link rel="shortcut icon" href="imgs/steam2.png">
...
<div class="play">
    <img class="logos" src="imgs\pc22.png">
  <br><br><br>
    <H2 style='margin-left: 75px; color:white' class ="darkcyan">ORDENADOR</H2>
</div>    
</section>
...
<?php
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
        ...
        echo "<div style='border: 5px solid darkcyan;' class='juego'>";
        echo "<div style='width: 200px;'>";
        echo "<img class='imagen' src='imgs/imagen_$id_juego.png' alt='$nombre'>";
        echo "<h2 style='color: white;'>$nombre</h2><br>";
        echo "</div>";
        echo "<p><h2 style='color: darkcyan;'>Género:</h2><br> <p style='color: white;'>$genero</p><br>";
        echo "<p><h2 style='color: darkcyan;'>Plataforma:</h2><br> <p style='color: white;'>$plataforma</p><br>";
        echo "<div class='comentarios'>";
        echo "<h2 style='color: darkcyan;'>Comentarios:</h2><br><p style='color: white;'>$comentarios</p><br>";
        echo "</div>";
        echo "<p><h2 style='color: darkcyan;'>Enlace:</h2><br> <a href='$link' style='color: white;'>$link</a></p>";
        echo "</div>";
    }
    echo "</div>";
