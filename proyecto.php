...
?>
	...
	<section class="centrar">
        ...
        <div class="contenedorSlider">
            <br>
            <h2 style="color:white">LOS JUEGOS DEL MES</h2>
            <br>
            <div id="slider">
                
                <div><h2 style="color:red" >Mario Party</h2> <br />
                    <img src="imgs/mario.png" alt="" srcset="">
                    
                </div>
                <div><h2 style="color:dodgerblue">God of War</h2> <br />
                    <img src="imgs/god3.png" alt="" srcset="">
                    
                </div>
                <div><h2 style="color:green">Halo</h2> <br />
                    <img src="imgs/halo2.png" alt="" srcset="">
                    
                </div>
                <div><h2 style="color:darkcyan">Diablo</h2> <br />
                    <img src="imgs/diablo2.png" alt="" srcset="">
    ...
    <!-- Creamos un seccion para la guia -->
    <section class="section2">
        ...
        <div class="contenedorsection2"> 
            ...
            <div class="imagen">                
                <div > 
                    <img src="imgs/guia2.jpg" alt="" srcset=""> 
                     
                </div> 
            </div> 
            <div class="texto"> 
                <a style="text-decoration:none; color:white; font-size: 24px; font-weight: bold;" href="https://www.3djuegos.com/juegos/resident-evil-4-remake/guias-y-trucos/guia-completa-resident-evil-4-remake-todos-trucos-secretos-armas-logros-misiones-secundarias">GUIA COMPLETA: Resident Evil 4 Remake - Guía completa: historia, todas las armas, tesoros, extras y más</a> 
            </div> 
        </div> 
